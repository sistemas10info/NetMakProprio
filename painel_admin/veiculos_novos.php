					...
					<table class="table-light table table-bordered table-striped table-hover f12" id="table-veiculos-novos" >
						<thead>
							<tr bgcolor='#D3D3D3'>
								...
								<th data-column-id="imagens" data-align="center" data-header-align="center" data-width="15%;">Imagens</th>
								<th data-column-id="estado" data-align="right" data-header-align="right"  data-width="10%;">Estado</th>
							</tr>
						</thead>
					</table>
				</div>
